        ...
        <div class="min-h-screen bg-white">
            ...
            <section class="bg-[#3056d3] py-6 px-4">
                <div class="max-w-xl mx-auto">
                    <form action="{{ route('advertisements.index') }}" method="GET" class="bg-white rounded-full flex items-center px-4 py-2 shadow">
                        <input
                                type="text"
                                name="search"
                        ...
                        />
                        <button type="submit" class="bg-violet-300 p-3 rounded-full">
                            <svg class="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l4.25 4.25c.41.41 1.09.41 1.5 0s.41-1.09 0-1.5L15.5 14zM10 14a4 4 0 110-8 4 4 0 010 8z"/>
                            </svg>
                        </button>
                    </form>
                </div>
